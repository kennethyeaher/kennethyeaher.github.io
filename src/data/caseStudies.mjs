  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        media: [
          { src: "/images/work/capstone/capstone-provenance.png", alt: "Provenance diagram in three hops. Hop one lists four evidence sources: student survey 24, resident survey 9, contextual interviews marked with a question mark and the label not recorded, and three blocks of secondary figures marked partly sourced. Hop two audits the thirteen fields of a persona card, eleven marked no survey item, two marked cohort level, one marked authored. Hop three connects five personas to three journey maps, with Alex and Priya marked no journey map", caption: "Two of the thirteen fields on a persona card have any survey basis, and both only as a cohort total. The question mark in the first row is the number of contextual interviews, which no document in the project records.", wide: true },
    ...
    sections: [
      {
        ...
        body: [
          "hiveSocial was building an events and social app for campus. When I picked up the design file it was called WTM, short for Watch The Moves, and the login artboard carried a note left for whoever came next: we still need to determine our logo for the app and design scheme, colour scheme.",
