...
export const caseStudies = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        media: [
          { src: "/images/work/capstone/journey-jessica.png", alt: "Jessica’s journey map across five stages, Awareness, Planning, Arrival, Experience and Post-Event, with rows for touchpoints, user actions, goals, feelings, pain points and opportunities", caption: "Jessica’s map is the only one of the three with a Planning stage. She reads the event map in advance and still meets unclear entrance signage when she arrives.", wide: true },
          { src: "/images/work/capstone/journey-tyler.png", alt: "Tyler’s journey map across four stages, Curiosity, Exploration, Experience and Reflection, with rows for touchpoints, user actions, goals, feelings, pain points and opportunities", caption: "Tyler’s map has no Planning stage because Tyler did not plan. He was walking to the bars on Baltimore Avenue, heard music from City Hall, and followed it.", wide: true },
