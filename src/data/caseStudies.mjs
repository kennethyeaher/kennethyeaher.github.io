...
export const caseStudies = [
  ...
  },
  {
    ...
    year: "2026",
    role: "Solo designer",
    timeline: "Course concept December 2025, solo redesign 2026",
    team: "Five-person INFM600 team; the redesign and system work are my own",
    skills: ["Information architecture", "Interaction design", "Design systems", "Service design", "Figma", "Accessibility"],
    summary:
      "A solo redesign of a campus health hub around one measure: how long it takes a University of Maryland student to go from noticing a symptom to knowing what to do about it.",
    ...
    evidence: {
      projectType: "solo redesign of a course concept",
